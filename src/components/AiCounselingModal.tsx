  ...
  const handleSendMessage = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (userText.toLowerCase().includes('diejek') || userText.toLowerCase().includes('verbal')) {
        ...
        reply = `Tindakan fisik atau ancaman adalah pelanggaran berat. Harap pertimbangkan untuk menekan tombol 'N-Help' agar Tim TP2K dan Guru BK segera melindungimu.`;
          ...
          <div className="flex-1 p-4 sm:p-6 bg-slate-50 overflow-y-auto space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="p-5 rounded-2xl bg-white border border-slate-200 shadow-xs space-y-3">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  1. Tangkap layar (screenshot) pesan berisi hinaan. 2. Jangan membalas di kolom komentar. 3. Blokir akun pelaku. 4. Lampirkan tangkapan layar ke fitur N-Help.
                </p>
                <div className="pt-2 border-t border-slate-100 flex items-center justify-between text-[11px]">
