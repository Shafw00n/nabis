...
export const MOOD_OPTIONS: MoodOption[] = [
  ...
  },
  {
    ...
    supportMsg: 'Kamu aman di sini. Kami sangat peduli padamu. Jika kamu mengalami atau melihat perundungan, klik tombol N-Help atau hubungi Konselor Sekolah sekarang.'
  }
];
...
export const MOCK_ARTICLES: Article[] = [
  {
    ...
    content: [
      ...
      '• Delegate (Minta Bantuan): Hubungi Wali Kelas, Guru BK, atau gunakan tombol N-Help.',
...
export const MOCK_QUIZ: QuizQuestion[] = [
  ...
  },
  {
    id: 2,
    type: 'myth_fact',
    question: 'Mitos atau Fakta: Fitur N-Help di NABIS menjamin privasi dan kerahasiaan identitas pelapor 100%.',
...
export const MOCK_GAMES: GameScenario[] = [
  {
    ...
    choices: [
      ...
      {
        id: 'c3',
        text: 'Melaporkan kejadian secara langsung ke Ruang BK atau melalui tombol N-Help.',
        isUpstander: true,
